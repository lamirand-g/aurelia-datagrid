System.register(["lodash/collection/sortByOrder", "../grid-constants"], function (_export) {
    "use strict";

    var _sortByOrder, GridConstants, Sorter;
    ...
    return {
        setters: [function (_lodashCollectionSortByOrder) {
            _sortByOrder = _lodashCollectionSortByOrder["default"];
