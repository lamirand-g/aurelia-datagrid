System.register(["lodash/collection/filter", "lodash/function/debounce"], function (_export) {
    "use strict";

    var _filter, _debounce, Filterer;
    ...
    return {
        setters: [function (_lodashCollectionFilter) {
            _filter = _lodashCollectionFilter["default"];
        }, function (_lodashFunctionDebounce) {
            _debounce = _lodashFunctionDebounce["default"];
        }],
        execute: function () {
            Filterer = (function () {
                function Filterer(grid, viewModel, observerLocator) {
                    ...
                    this.observeColumn = function (column) {
                        if (column.filter) {
                            _this.observerLocator.getObserver(column.filter, 'value').subscribe(_debounce(function () {
                ...
                _createClass(Filterer, [{
                    ...
                    value: function filterLocally(items, filterInformation) {
                        ...
                        if (filterInformation.value || filterInformation.value === false) {
                            filteredItems = _filter(this.unfilteredItems, function (item) {
